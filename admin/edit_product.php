                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <select name="kategori" class="form-control">
                                                               <?php
                                                                $kategori = ["Skincare", "Makeup", "Body Care", "Hair Care", "Sunscreen", "Facial Wash", "Serum", "Toner", "Lip Care", "Mask"];
                                                            ...
                                                            <select name="merk" class="form-control">
                                                                <?php
                                                                $merk = ["Wardah", "Emina", "Somethinc", "Azarine", "MS Glow", "Scarlett", "Garnier", "Nivea", "Pond's", "Make Over", "Innisfree", "Hada Labo", "The Originote", "Skintific", "YOU", "Implora"];
